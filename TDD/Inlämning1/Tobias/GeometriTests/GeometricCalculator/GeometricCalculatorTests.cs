...
namespace Geometri.GeometricCalculator.Tests
{
    ...
    {
        [TestMethod()]
        public void GetAreaTest01_CalculateTheAreaOfTheObjectsInTheArray_ReturnsArea()
        {
        ...
        [TestMethod()]
        public void GetPerimeterTest01_CalculateThePerimeterOfTheObjectsInTheArray_ReturnsArea()
        {
            var geoCalc = new GeometricCalculator();
        ...
        [TestMethod()]
        public void GetPerimeterTests02_ArrayIsNull_ReturnsZero()
        {
            var geoCalc = new GeometricCalculator();
